...
class SummaryStatsDialog extends JDialog {
...
/// etc
   ...
   public Date isValidDate (String date) { 
    ...
    public SummaryStatsDialog(final TableDemo aFrame) { 
        super(aFrame, true);
	...
	*/
	...
	// maybe ask, like, via buttons. 

	/// get the data for the first table.
	/*
	JTable speciesSum1 = new JTable (	new AbstractTableModel() {
