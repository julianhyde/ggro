...
public class DbSpeciesDo { 
	...
	public static void deleteSpeciesRow (java.sql.Date date) throws Throwable { 

		c.setTime (date);
		Util2.normalize(c);

		String del = "delete from " + Consts.getSpeciesTable() + " where date_ = ?";
