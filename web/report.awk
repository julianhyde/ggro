...
END {
    ...
    printf "<p>Data have not been entirely checked &mdash; contact <a href='mailto:rfielding@parksconservancy.org'>Rose Fielding</a> for final results and for permission to use.</p>\n";
